...
(function (root, factory) {
  ...
  // reste `banano`/`orangine`/`kiwano`. Et on ne renomme qu'un bot AU REPOS —
  ...
  BandasNet.prototype._refreshBotIdentities = function () {
  ...
  BandasNet.prototype._retireBots = function (session) {
    var self = this;
  ...
  //     CLASSÉ (chaque humain une fois par série — anti-farm ; un bot compte à
  //     chaque fois). Gagner ne coûte PAS de disque : on garde sa vie en gagnant.
  //   • PERDRE (contre un humain ou un bot) termine la série du perdant CLASSÉ,
  //     l'enregistre, et lui coûte UN DISQUE (onDiscLost).
