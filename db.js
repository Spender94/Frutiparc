...
async function listAllUsers() {
  const { rows } = await pool.query(
    'SELECT id, username, display_name, xp, kikooz, fbouille, gender, is_moderator, fruti_sign, fruti_sign_b, real_job, frutijob, birthday, country, region, city, created_at FROM users ORDER BY created_at DESC'
  );
  return rows;
}
